        ...
        <div className="todos">
          ...
          {todos.map((item) => {
           ...
           <div key={item.id} className="todo flex justify-between my-2">
              ...
              <input name={item.id} className="mt-2" onChange={handleChange} type="checkbox" checked={item.isCompleted} />
              </div>
              <div className={item.isCompleted?"line-through px-2":"px-2"}>{item.todo}</div>
